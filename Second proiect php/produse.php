    ...
    function produse()
{
        ...
        if ($result->num_rows > 0)
        {
                ...
                <div class='col-12'>
                <table class='table'><tr><th style='border: 0px;'></th><th>Tip</th><th>Producator</th><th>Nume</th><th>Pret</th><tr>";
                while ($row = $result->fetch_assoc())
                {       
                        
                        echo "<tr><td style='border: 0px;'></td><td> " . $row['Tip'] . "</td><td> " . $row['Producator'] . "</td><td> " . $row['Nume'] . "</td><td>".$row['Pret']." Lei</td><tr>";;
                }
